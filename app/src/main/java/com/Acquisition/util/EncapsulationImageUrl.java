...
public class EncapsulationImageUrl {
    ...
    public static String encapsulation(String srcId) {
        ...
        String imageurl = "http://219.142.81.65:8081/blade-system/fieldInspectTask/downloadFileBySrcId?srcId=" + srcId + "&&X-Access-Token=" + BaseApplication.userInfo.getAccessToken();
