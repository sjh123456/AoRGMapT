 ...
 * 质量检查
 */
public class QualityTestingActivity extends AppCompatActivity {

    private final static String TAG = "QualityTestingActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                QualityTestingActivity.this.finish();
            }
        });
                ...
                DataAcquisitionUtil.getInstance().submit(map, new RequestUtil.OnResponseListener<ResponseDataItem<PlanBean>>() {
                    ...
                    public void onsuccess(ResponseDataItem<PlanBean> responseDataItem) {
                        ...
                        if (responseDataItem.isSuccess()) {
                            ...
                            //上传成功之后，删除本地项目
                            if (key != -1) {
                                LocalDataUtil.getIntance(QualityTestingActivity.this).deletePlanInfo(key);
                            }
                            QualityTestingActivity.this.finish();

                        } else {
                            Toast.makeText(QualityTestingActivity.this, "提交失败，请重新提交", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        mCheckImageAdapter.setOnImageClickListtener(new ImageAdapter.OnImageClickListener() {
            ...
            public void onAddClick(View view) {
                ...
                if (mCheckImageBeans.size() == 7) {
                    Toast.makeText(QualityTestingActivity.this, "照片不能超过6张", Toast.LENGTH_SHORT).show();
                } else {
                    mChooseImageType = 0;
                    ChooseImageDialog.getInstance().show(QualityTestingActivity.this);
                }
                        ...
                        DataAcquisitionUtil.getInstance().remove(id, new RequestUtil.OnResponseListener<ResponseDataItem>() {
                            ...
                            public void onsuccess(ResponseDataItem o) {
                                if (o.isSuccess()) {
                                    ...
                                    Toast.makeText(QualityTestingActivity.this, "删除失败，请重试", Toast.LENGTH_SHORT).show();
                                }
...
//获取当前时间
    ...
    private void addPhotos(String taskid, PlanBean planBean) {
        ...
        if (mCheckImageBeans != null && mCheckImageBeans.size() > 0) {
            ...
            EncapsulationImageUrl.updatePhotos(taskid, "质量检查", "p1", mCheckImageBeans, photoFiles);
        }
        if (mRectificationImageBeans != null && mRectificationImageBeans.size() > 0) {
            ...
            EncapsulationImageUrl.updatePhotos(taskid, "质量检查", "p2", mRectificationImageBeans, photoFiles2);
        }
        if (mSceneImageBeans != null && mSceneImageBeans.size() > 0) {
            ...
            EncapsulationImageUrl.updatePhotos(taskid, "质量检查", "p3", mSceneImageBeans, photoFiles3);
        }
        if (mAchievementsImageBeans != null && mAchievementsImageBeans.size() > 0) {
            List<PlanBean.PhotoFile> photoFiles4 = new ArrayList<>();
            if (planBean != null) {
                photoFiles4 = planBean.getFiles4();
            }
            EncapsulationImageUrl.updatePhotos(taskid, "质量检查", "p4", mAchievementsImageBeans, photoFiles4);
        }
